	...
	function grace_church_template_team_4_output($post_options, $post_data) {
		...
		?>
			<div<?php grace_church_show_layout( $post_options['tag_id'] ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''); ?>
				...
				<div class="sc_team_item_avatar"><?php grace_church_show_layout($post_options['photo']); ?>
					<div class="sc_team_item_hover">
						<div class="sc_team_item_info">
							...
							<div class="sc_team_item_socials"><?php grace_church_show_layout($post_options['socials']); ?></div>
							<div class="sc_team_item_email"></div>
						</div>
					</div>
				</div>
			</div>
