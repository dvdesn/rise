...
if ( !function_exists( 'grace_church_essgrids_get_popular_posts_query' ) ) {
    add_filter( 'essgrid_get_posts', 'grace_church_essgrids_get_popular_posts_query', 10, 2 );
    add_filter( 'essgrid_get_posts_by_ids_query', 'grace_church_essgrids_get_popular_posts_query', 10, 2 );
    add_filter( 'essgrid_get_popular_posts_query', 'grace_church_essgrids_get_popular_posts_query', 10, 2 );
    add_filter( 'essgrid_get_related_posts', 'grace_church_essgrids_get_popular_posts_query', 10, 2 );
    add_filter( 'essgrid_get_related_posts_query', 'grace_church_essgrids_get_popular_posts_query', 10, 2 );
    function grace_church_essgrids_get_popular_posts_query($args, $post_id) {
