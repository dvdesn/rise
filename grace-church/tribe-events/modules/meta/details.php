...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Details', 'grace-church' ) ?> </h3>
	<dl>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<dt> <?php esc_html_e( 'Date:', 'grace-church' ) ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr updated published dtstart" title="<?php ( $start_ts ) ?>"> <?php grace_church_show_layout( $start_date ) ?> </abbr>
			</dd>
		...
		// Single day events
			...
			<dt> <?php esc_html_e( 'Time:', 'grace-church' ) ?> </dt>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<dt> <?php esc_html_e( 'Cost:', 'grace-church' ) ?> </dt>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<dt> <?php esc_html_e( 'Website:', 'grace-church' ) ?> </dt>
