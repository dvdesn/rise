...
class grace_church_widget_socials extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'grace_church_widget_socials', esc_html__('Grace-Church - Show logo and social links', 'trx_utils'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
            ...
            <?php
			grace_church_show_layout(grace_church_show_custom_field($this->get_field_id( 'logo_media' ), array('type'=>'mediamanager', 'media_field_id'=>$this->get_field_id( 'logo_image' )), null));
			if ($logo_image) {
			?>
