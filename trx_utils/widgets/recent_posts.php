 ...
 */
add_action( 'widgets_init', 'grace_church_widget_recent_posts_load' );

/**
 * Register our widget.
 */
function grace_church_widget_recent_posts_load() {
	register_widget('grace_church_widget_recent_posts');
}

/**
 * Recent posts Widget class.
 */
class grace_church_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		...
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'grace_church_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'grace_church_widget_recent_posts', esc_html__('Grace-Church - Recent Posts', 'trx_utils'), $widget_ops, $control_ops );

		// Add thumb sizes into list
		if (function_exists('grace_church_add_thumb_sizes')) {
			grace_church_add_thumb_sizes( array(
				'layout' => 'widgets',
				'w'      => 75,
				'h'      => 75,
				'h_crop' => 75,
				'title'  => __( 'Widgets', 'trx_utils' )
			) );
		}
	}
