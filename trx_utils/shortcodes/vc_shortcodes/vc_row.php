...
// Add Grace-Church color scheme in the row
if ($scheme && !grace_church_param_is_off($scheme) && !grace_church_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
