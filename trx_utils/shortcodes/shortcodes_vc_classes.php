...
// Shortcode template
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCode' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeSingle' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeSingle extends GRACE_CHURCH_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeAlone' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeAlone extends GRACE_CHURCH_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeContainer' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeContainer extends GRACE_CHURCH_VC_ShortCode {
...
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeCollection' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeCollection extends GRACE_CHURCH_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeItem' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeItem extends GRACE_CHURCH_VC_ShortCode {
...
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeColumns' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeColumns extends GRACE_CHURCH_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeAccordion' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class GRACE_CHURCH_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeToggles' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeToggles extends GRACE_CHURCH_VC_ShortCodeAccordion {}
	abstract class GRACE_CHURCH_VC_ShortCodeTogglesItem extends GRACE_CHURCH_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'GRACE_CHURCH_VC_ShortCodeTabs' ) ) {
	abstract class GRACE_CHURCH_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class GRACE_CHURCH_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
