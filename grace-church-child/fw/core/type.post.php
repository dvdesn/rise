...
if (!function_exists('grace_church_post_theme_setup')) {
	...
	function grace_church_post_theme_setup() {
		...
		if (isset($GRACE_CHURCH_GLOBALS['post_override_options']) && $GRACE_CHURCH_GLOBALS['post_override_options']['page']=='post') {
			add_action('admin_enqueue_scripts', 						'grace_church_post_admin_scripts');
			add_action('grace_church_action_post_before_show_override_options',		'grace_church_post_before_show_override_options', 10, 2);
			add_action('grace_church_action_post_after_show_override_options',		'grace_church_post_after_show_override_options', 10, 2);
...
if (!function_exists('grace_church_post_add_options_column')) {
	//Handler of add_filter('manage_edit-{post_type}_columns',	'grace_church_post_add_options_column', 9);
...
if (!function_exists('grace_church_post_fill_options_column')) {
	//Handler of add_filter('manage_{post_type}_custom_column',	'grace_church_post_fill_options_column', 9, 2);
...
if (!function_exists('grace_church_post_admin_scripts')) {
	//Handler of add_action('admin_enqueue_scripts', 'grace_church_post_admin_scripts');
	function grace_church_post_admin_scripts() {
		...
		if (isset($GRACE_CHURCH_GLOBALS['post_override_options']) && $GRACE_CHURCH_GLOBALS['post_override_options']['page']=='post' && grace_church_storage_isset('options', 'show_reviews'))
			wp_enqueue_script( 'grace-church-core-reviews-script', grace_church_get_file_url('js/core.reviews.js'), array('jquery'), null, true );
	}
}


// Open reviews container before Theme options block
if (!function_exists('grace_church_post_before_show_override_options')) {
	//Handler of add_action('grace_church_action_post_before_show_override_options', 'grace_church_post_before_show_override_options', 10, 2);
	function grace_church_post_before_show_override_options($post_type, $post_id) {
		$max_level = max(5, (int) grace_church_get_theme_option('reviews_max_level'));
        grace_church_set_global_array('js_vars', 'reviews_levels', grace_church_get_theme_option('reviews_criterias_levels'));
        grace_church_set_global_array('js_vars', 'reviews_max_level', (int) $max_level);
        grace_church_set_global_array('js_vars', 'reviews_allow_user_marks', true);
        ?>
...
if (!function_exists('grace_church_post_after_show_override_options')) {
	//Handler of add_action('grace_church_action_post_after_show_override_options', 'grace_church_post_after_show_override_options', 10, 2);
	function grace_church_post_after_show_override_options($post_type, $post_id) {
		?>
		</div>
		<?php
	}
...
if (!function_exists('grace_church_post_load_custom_options')) {
	//Handler of add_filter('grace_church_filter_post_load_custom_options', 'grace_church_post_load_custom_options', 10, 3);
...
if (!function_exists('grace_church_post_show_custom_field_option')) {
	//Handler of add_filter('grace_church_filter_post_show_custom_field_option',	'grace_church_post_show_custom_field_option', 10, 4);
...
if (!function_exists('grace_church_post_save_custom_options')) {
	//Handler of add_filter('grace_church_filter_post_save_custom_options',	'grace_church_post_save_custom_options', 10, 3);
...
if ( !function_exists( 'grace_church_post_list_post_types' ) ) {
	//Handler of add_filter('grace_church_filter_list_post_types', 	'grace_church_post_list_post_types', 9, 1);
...
if ( !function_exists( 'grace_church_post_detect_inheritance_key' ) ) {
	//Handler of add_filter('grace_church_filter_detect_inheritance_key',	'grace_church_post_detect_inheritance_key', 10, 1);
...
if ( !function_exists( 'grace_church_post_get_blog_type' ) ) {
	//Handler of add_filter('grace_church_filter_get_blog_type',	'grace_church_post_get_blog_type', 10, 2);
...
if ( !function_exists( 'grace_church_post_get_blog_title' ) ) {
	//Handler of add_filter('grace_church_filter_get_blog_title',	'grace_church_post_get_blog_title', 10, 2);
	function grace_church_post_get_blog_title($title, $page) {
		if (!empty($title)) return $title;
		
		if ( $page == 'blog' )
			$title = esc_html__( 'Todas las noticias', 'grace-church' );
		else if ( $page == 'author' ) {
			...
			$title = sprintf( esc_html__( 'Buscar: %s', 'grace-church' ), get_search_query() );
...
if ( !function_exists( 'grace_church_post_get_stream_page_title' ) ) {
	//Handler of add_filter('grace_church_filter_get_stream_page_title',	'grace_church_post_get_stream_page_title', 10, 2);
...
if ( !function_exists( 'grace_church_post_get_stream_page_id' ) ) {
	//Handler of add_filter('grace_church_filter_get_stream_page_id',	'grace_church_post_get_stream_page_id', 10, 2);
...
if ( !function_exists( 'grace_church_post_get_stream_page_link' ) ) {
	//Handler of add_filter('grace_church_filter_get_stream_page_link',	'grace_church_post_get_stream_page_link', 10, 2);
...
if ( !function_exists( 'grace_church_post_get_current_taxonomy' ) ) {
	//Handler of add_filter('grace_church_filter_get_current_taxonomy',	'grace_church_post_get_current_taxonomy', 10, 2);
...
if ( !function_exists( 'grace_church_post_is_taxonomy' ) ) {
	//Handler of add_filter('grace_church_filter_is_taxonomy',	'grace_church_post_is_taxonomy', 10, 2);
...
if ( !function_exists( 'grace_church_post_get_period_links' ) ) {
	//Handler of add_filter('grace_church_filter_get_period_links',	'grace_church_post_get_period_links', 10, 3);
...
if ( !function_exists( 'grace_church_post_calendar_get_month_link' ) ) {
	//Handler of add_filter('grace_church_filter_calendar_get_month_link',	'grace_church_post_calendar_get_month_link', 10, 2);
...
if ( !function_exists( 'grace_church_post_calendar_get_prev_month' ) ) {
	//Handler of add_filter('grace_church_filter_calendar_get_prev_month',	'grace_church_post_calendar_get_prev_month', 10, 2);
...
if ( !function_exists( 'grace_church_post_calendar_get_next_month' ) ) {
	//Handler of add_filter('grace_church_filter_calendar_get_next_month',	'grace_church_post_calendar_get_next_month', 10, 2);
...
if ( !function_exists( 'grace_church_post_calendar_get_curr_month_posts' ) ) {
	//Handler of add_filter('grace_church_filter_calendar_get_curr_month_posts',	'grace_church_post_calendar_get_curr_month_posts', 10, 2);
